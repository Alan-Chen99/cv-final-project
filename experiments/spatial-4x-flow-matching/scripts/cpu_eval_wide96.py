"""Quick CPU evaluation of wide96 model on small subset.
Used when GPU is unavailable. Gives rough CRPS estimate."""
import sys, os, time
...
from flow_matching_v2 import (
    ...
    apply_addcl, crps_ensemble_correct,
)
import numpy as np
import torch

MODEL_DIR = "/home/chenxy/orcd/pool/datasets/research3/models/unet_wide96_amp"
...
for i in range(n_samples):
    ...
    ensemble_preds = np.stack(ensemble_preds, axis=1)  # (1, M, 1, H, W)
    gt = hr[i, 0, ...].numpy()
